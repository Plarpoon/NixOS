...
with lib;
{
  ...
  config = mkIf (config.kde.enable) {
    ...
    plasma-manager.users.${vars.user} = {
      plasma = {
        enable = true;
        shortcuts = {
          "ActivityManager"."switch-to-activity-be3f90f3-9de3-4990-92e3-80f34be8beaa" = [ ];
        ...
        configFile = {
          ...
          "kactivitymanagerdrc"."activities"."be3f90f3-9de3-4990-92e3-80f34be8beaa" = "Default";
          "kactivitymanagerdrc"."main"."currentActivity" = "be3f90f3-9de3-4990-92e3-80f34be8beaa";
          "kcminputrc"."Keyboard"."NumLock" = 0;
          "kcminputrc"."Libinput.1267.12423.ELAN1300:00 04F3:3087 Touchpad"."NaturalScroll" = true;
          "kcminputrc"."Libinput.1267.12423.ELAN1300:00 04F3:3087 Touchpad"."TapToClick" = true;
          ...
          "kdeglobals"."General"."AccentColor" = "206,123,110";
          ...
          "kdeglobals"."WM"."activeBackground" = "30,30,30";
          ...
          "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{53d4b509-0e7b-44d1-b49d-4a55befa8285}";
          ...
          "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{5816aeb4-ccac-4f1d-82fd-4c5f2c6b99e4}";
          ...
          "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{219b8e69-0a0a-4966-af78-9d918fc603e4}";
          ...
          "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{4f58ef25-ed8a-482a-92de-ba3a4584906d}";
          ...
          "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{1371ac2e-28bc-4f7c-aa92-2f882cae2b0e}";
          ...
          "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{d60f7908-1a0b-4ad3-9b13-0cb23a7ea77c}";
          ...
          "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{cbf2ab58-d66b-4d72-91a3-f09cbc12ea61}";
          ...
          "kwinrc"."Desktops"."Id_1" = "83ca6420-0855-4425-b389-3645ad95eb54";
          "kwinrc"."Desktops"."Id_2" = "36b84f2e-3c1e-4128-ad15-a2fa7108fbe2";
          "kwinrc"."Desktops"."Id_3" = "19863cb2-7efe-473f-9bc4-68732f441751";
          "kwinrc"."Desktops"."Id_4" = "08319b3f-e738-4b0d-b473-678f96fc5b1c";
          ...
          "kwinrc"."Tiling.82ec6af9-8c22-5627-8dde-a3d0b4328e6a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          "kwinrc"."Windows"."RollOverDesktops" = true;
          "kwinrc"."Xwayland"."Scale" = 1;
          "kwinrc"."org.kde.kdecoration2"."ButtonsOnLeft" = "";
          "kwinrc"."org.kde.kdecoration2"."ButtonsOnRight" = "IX";
          "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
          "plasma-localerc"."Formats"."LC_ADDRESS" = "it_IT.UTF-8";
          "plasma-localerc"."Formats"."LC_MEASUREMENT" = "it_IT.UTF-8";
          "plasma-localerc"."Formats"."LC_MONETARY" = "it_IT.UTF-8";
          "plasma-localerc"."Formats"."LC_NAME" = "it_IT.UTF-8";
          "plasma-localerc"."Formats"."LC_NUMERIC" = "it_IT.UTF-8";
          "plasma-localerc"."Formats"."LC_PAPER" = "it_IT.UTF-8";
          "plasma-localerc"."Formats"."LC_TELEPHONE" = "it_IT.UTF-8";
          "plasma-localerc"."Formats"."LC_TIME" = "it_IT.UTF-8";
