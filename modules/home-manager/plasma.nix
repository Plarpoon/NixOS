{ inputs, ... }:
{
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput.1267.12423.ELAN1300:00 04F3:3087 Touchpad"."NaturalScroll" =
        true;
      "kcminputrc"."Libinput.1267.12423.ELAN1300:00 04F3:3087 Touchpad"."TapToClick" =
        true;
      ...
      "kwinrc"."Tiling.82ec6af9-8c22-5627-8dde-a3d0b4328e6a"."tiles" = ''
        {"layoutDirection":"horizontal","tiles":[{"width":0.25},{"width":0.5},{"width":0.25}]}'';
      ...
      "systemsettingsrc"."systemsettings_sidebar_mode"."HighlightNonDefaultSettings" =
        true;
    };
  };
}
